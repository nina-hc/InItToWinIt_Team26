 ...
 * It's in charge of creating Tile objects that will be used to build the game Board
 *
...
public class Tile {
    ...
    /**
     * Roll number assigned to each Tile
     * When the dice rolls the roll number, players on the tile can collect the corresponding resource from the Bank
     */
    private int tileRollNum;

    /**
     * Type of resource players on the tile will collect when the roll number is rolled
     */
    ...
    /**
     * Tile constructor, to create Tile objects
     * Each Tile will have a unique ID number, roll number, and resource type
     *
     * @param tileID ID number used to reference Tile object
     * @param tileRollNum associated roll number on tile, determines when the resource is collected
