 ...
 * It's in charge of creating Node objects that will be used to build the game Board
 *
...
public class Node {
    ...
    /**
     * Node identification number from 0-53, that will be used to build settlements, cities and roads
     * Allows for reference to specific Node objects
     */
    private int nodeID;

    /**
     * Settlement object that's placed on a Node
     * Null if no Settlement has been placed
     */
    private Settlement settlement;

    /**
     * City object that's place on a Node
     * Null if no City has been placed
     */
    private City city;
    ...
    /**
     * Node constructor, creates Node objects
     * Each will have a unique ID number
     *
    ...
    /**
     * Method to place a City on a Node, must be a Settlement previously in order to become a City
     *
